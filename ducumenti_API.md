{
  ...
  "paths": {
    ...
    "/auth/utilizadores/{utilizador_id}": {
      "put": {
        "tags": [
          "Autenticação"
        ],
        "summary": "Editar utilizador (apenas Gestor)",
        "description": "Atualiza nome, email, password, role e/ou ativo. Só envia os campos que quer alterar.",
        "operationId": "atualizar_utilizador_auth_utilizadores__utilizador_id__put",
        "security": [
          {
            "HTTPBearer": []
          }
    ...
    "/vendas/numero/{numero}/cancelar": {
      "post": {
        "tags": [
          "Vendas"
        ],
        "summary": "Anular venda pelo número da factura (Gestor)",
        "description": "Busca a venda pelo número da factura (dívida gerada) e anula: devolve o stock, reverte a fidelidade do cliente, remove o lançamento de caixa (se à vista) e cancela a dívida (se a crédito e sem pagamentos ainda).",
        "operationId": "cancelar_por_numero_vendas_numero__numero__cancelar_post",
        "security": [
          {
            "HTTPBearer": []
          }
        ...
        "responses": {
          ...
          "400": {
            "description": "Venda já anulada ou dívida já tem pagamento"
          },
          "422": {
            "description": "Validation Error",
            "content": {
    ...
    "/vendas/{id}/cancelar": {
      "post": {
        ...
        "summary": "Anular venda (Gestor)",
        "description": "Anula a venda: devolve o stock, reverte a fidelidade do cliente, remove o lançamento de caixa (se à vista) e cancela a dívida (se a crédito e sem pagamentos ainda). Bloqueia se a dívida gerada já tiver algum pagamento.",
        "operationId": "cancelar_vendas__id__cancelar_post",
        "security": [
          {
            "HTTPBearer": []
          }
    ...
    "/dividas/{divida_id}/pagamentos/{pagamento_id}/cancelar": {
      "post": {
        "tags": [
          "Dívidas"
        ],
        "summary": "Anular um pagamento específico (Gestor)",
        "description": "Anula um pagamento feito por engano: remove esse recibo, diminui o `valor_pago` da dívida na conta certa e volta o status para DIVIDA (se tinha ficado PAGA por causa desse pagamento). Não mexe nos outros pagamentos já feitos.",
        "operationId": "cancelar_pagamento_dividas__divida_id__pagamentos__pagamento_id__cancelar_post",
        "security": [
          {
            "HTTPBearer": []
          }
        ...
        "responses": {
          ...
          "404": {
            "description": "Dívida ou pagamento não encontrado"
          },
          "422": {
            "description": "Validation Error",
            "content": {
    ...
    "/dividas/pagamentos/numero/{numero}/cancelar": {
      "post": {
        "tags": [
          "Dívidas"
        ],
        "summary": "Anular um pagamento pelo número do recibo (Gestor)",
        "description": "Mesmo comportamento de anular pagamento, mas busca direto pelo número sequencial do recibo, sem precisar do divida_id.",
        "operationId": "cancelar_pagamento_por_numero_dividas_pagamentos_numero__numero__cancelar_post",
        "security": [
          {
            "HTTPBearer": []
          }
      ...
      "PagamentoDividaResponse": {
        "properties": {
          ...
          "numero_formatado": {
            ...
            "title": "Numero Formatado",
            "description": "Número do recibo formatado, ex: RC0001",
            "examples": [
              "RC0001"
            ]
          },
      ...
      "UtilizadorUpdate": {
        "properties": {
          ...
          "password": {
            ...
            "title": "Password",
            "description": "Nova password (deixa em branco para não alterar)",
            "examples": [
              "novaSenha123"
            ]
          },
          ...
          "ativo": {
            ...
            "title": "Ativo",
            "description": "Ativar/desativar o utilizador"
          }
        },
        "type": "object",
        "title": "UtilizadorUpdate"
      },
      "ValidationError": {
        "properties": {
          "loc": {
      ...
      "VendaCreate": {
        "properties": {
          ...
          "valor_final_desejado": {
            ...
            "title": "Valor Final Desejado",
            "description": "Valor que o cliente quer pagar no final (Kz). O desconto necessário é calculado automaticamente. Tem prioridade sobre desconto_percentual se ambos forem enviados."
          },
          "credito": {
            "type": "boolean",
            "title": "Credito",
      ...
      "VendaResponse": {
        "properties": {
          ...
          "cancelada_em": {
            ...
            "title": "Cancelada Em",
            "description": "Data em que a venda foi anulada, null se ainda está ativa"
          },
          "itens": {
            "items": {
