const pt = {
  ...
  clients: {
    ...
    colEmail: 'Email', colNif: 'NIF', colAddress: 'Endereço', colCreditBalance: 'Saldo de crédito',
    colRegistered: 'Registado em',
  ...
  sales: {
    ...
    debtOverpaymentDoneTitle: 'Saldo de crédito gerado',
    debtOverpaymentDoneDesc: 'O cliente pagou {{value}} a mais do que devia — esse valor ficou como saldo de crédito e será usado automaticamente na próxima compra.',
    creditBalanceTitle: 'Cliente com saldo de crédito',
    creditBalanceDesc: 'Este cliente tem {{value}} de saldo de crédito (excesso de pagamentos anteriores) — será aplicado automaticamente no total desta venda.',
    creditBalanceApplied: 'Saldo de crédito aplicado',
  ...
  deliveryNotes: {
    ...
    clientMode: { manual: 'Manual', existente: 'Do sistema', nenhum: 'Sem cliente' },
    selectClientPlaceholder: 'Selecionar cliente...',
    fieldClientName: 'Nome do cliente', clientNamePlaceholder: 'Ex: João dos Santos',
    fieldClientNif: 'NIF', clientNifPlaceholder: 'Ex: 123456789',
    fieldClientPhone: 'Número', clientPhonePlaceholder: 'Ex: 923456789',
    fieldClientAddress: 'Local', clientAddressPlaceholder: 'Ex: Luanda, Talatona',
    noClientNote: 'Nenhum dado de cliente será impresso na nota.',
  ...
  reports: {
    ...
    tabDebtClients: 'Clientes com Dívida',
    ...
    ledgerViewCreditHistory: 'Ver histórico', ledgerCreditHistoryTitle: 'Histórico do saldo de crédito',
    ledgerCurrentCreditBalance: 'Saldo de crédito atual', ledgerCreditHistoryEmpty: 'Sem movimentos de saldo',
    ledgerCreditMovementIn: 'Entrou (pagamento a mais)', ledgerCreditMovementOut: 'Usado numa venda',
    ledgerCreditBalanceAfter: 'Saldo após este movimento',
  ...
  users: {
    ...
    empty: 'Nenhum utilizador encontrado', newTitle: 'Novo utilizador', editTitle: 'Editar utilizador',
    fieldFullName: 'Nome completo', fieldPassword: 'Password', fieldNewPassword: 'Nova password',
    fieldProfile: 'Perfil',
    fullNamePlaceholder: 'Ex: Maria Silva', emailPlaceholder: 'Ex: maria@bisness.com',
    passwordPlaceholder: 'Mínimo 6 caracteres', newPasswordPlaceholder: 'Deixe em branco para manter a atual',
    create: 'Criar utilizador', creating: 'A criar...',
